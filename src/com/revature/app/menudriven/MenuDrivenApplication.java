package com.revature.app.menudriven;
...
public class MenuDrivenApplication {
	...
	private static void searchSpecificForm(UserDao userDao) throws SQLException {
	...
	private static void deleteForm(UserDao userDao) throws SQLException {
		Scanner scan = new Scanner(System.in);
	...
	private static void updateForm(UserDao userDao) throws SQLException {
		Scanner scan = new Scanner(System.in);
	...
	private static void addForm(UserDao userDao) throws SQLException {
		Scanner scan = new Scanner(System.in);
